...
// User list will be used as a fake database as a demo
...
type UserMap map[int32]User
type UserList []User

func (t *UserMap) FindUser(id int32) (User, error) {
	user, ok := (*t)[id]
	if ok {
		return user, nil
	}
...
func (t *UserMap) AddUser(newUser User) {
